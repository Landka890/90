...
TOKEN = '7237195855:AAGHaRgR-Se8Fha99dh9AqKGQz9WStk5CzU'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1004237896627
CHANNEL_ID = -1004237896627
error_channel_id = -1004237896627
...
def add_or_remove_user(message):
    ...
    if len(cmd_parts) < 2:
        bot.send_message(chat_id, "*Invalid command format. Use /add <user_id> <plan> <days> or /remove <user_id>.*", parse_mode='Markdown')
        return
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please reach out to @JATIN_OWNER for support.*", parse_mode='Markdown')
    else:
